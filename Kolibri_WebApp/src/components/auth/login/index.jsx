      ...
      <main className='main'>
        <div className='frame'>
          ...
          <form onSubmit={onSubmit} className='login_form'>
            ...
            <button
              ...
              className={`submit_btn button ${
                isSigningIn ? 'signing_in_true' : 'signing_in_false'
              }`}
            >
          ...
          <div className='or_container'>
            <div className='or_buffer_div'></div>
          ...
          <button
            ...
            className={`google_signingIn_btn button  ${
              isSigningIn ? 'google_signingIn_true' : 'google_signingIn_false'
            }`}
          >
            <svg
